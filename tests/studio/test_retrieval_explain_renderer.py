...
def test_retrieval_explain_renderer_scripts_and_wiring() -> None:
    ...
    assert "retrieval_explain" in renderer_ids
    ...
    assert "renderRetrievalExplainElement(el, handleAction)" in renderer
    ...
    assert "renderRetrievalControls" in retrieval_renderer
...
def test_retrieval_explain_renderer_snapshot_strings() -> None:
    ...
    assert "Retrieval tuning" in renderer
