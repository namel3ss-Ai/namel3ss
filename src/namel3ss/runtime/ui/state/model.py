...
from namel3ss.runtime.ui.contracts.program_contract import PageContract, ProgramContract
...
def page_decl_for_name(program_ir: ProgramContract, page_name: str | None) -> PageContract | None:
    if not page_name:
        return None
