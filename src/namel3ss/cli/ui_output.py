...
Start
  n3 new <template> <name>        # scaffold a project (run `n3 list` to list templates)
...
Advanced
  ...
  n3 proof <file.ai> --json       # write engine proof (contract snapshot)
  n3 verify <file.ai> --prod      # governance checks (contract gate)
  n3 when <file.ai> --json        # check contract compatibility
