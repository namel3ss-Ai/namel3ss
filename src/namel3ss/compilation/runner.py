...
from namel3ss.compilation.model import CompiledModule, GeneratedProject, TARGET_C, TARGET_RUST, TARGET_WASM
...
def _normalize_language(value: str) -> str:
    ...
    if text in {TARGET_C, TARGET_RUST, TARGET_WASM}:
        return text
    raise Namel3ssError(
        build_guidance_message(
            what=f"Unsupported language '{text or '<empty>'}'.",
            why="Compile supports c, rust, and wasm.",
