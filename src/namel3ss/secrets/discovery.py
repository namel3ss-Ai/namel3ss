...
PROVIDER_ENV = {
    ...
    "huggingface": "NAMEL3SS_HUGGINGFACE_API_KEY",
    "speech": "NAMEL3SS_SPEECH_API_KEY",
    "third_party_apis": "NAMEL3SS_THIRD_PARTY_APIS_KEY",
}
...
_ENV_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "NAMEL3SS_HUGGINGFACE_API_KEY": ("HUGGINGFACE_API_KEY", "HUGGINGFACEHUB_API_TOKEN"),
    "NAMEL3SS_SPEECH_API_KEY": ("SPEECH_API_KEY",),
    "NAMEL3SS_THIRD_PARTY_APIS_KEY": ("THIRD_PARTY_APIS_KEY",),
}
